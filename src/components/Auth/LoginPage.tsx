              ...
              <div className={`relative bg-white/60 backdrop-blur-md rounded-3xl p-10 border border-white/40 shadow-xl transition-all duration-500 ${
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-center mb-10">
                    <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl mb-6 shadow-lg transition-all duration-500 bg-gradient-to-r from-blue-500 to-cyan-500">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                      <div className="absolute inset-0 rounded-xl transition-all duration-500 bg-gradient-to-r from-blue-500 to-cyan-500"></div>
                      <div className="absolute inset-0 bg-gradient-to-b from-white/15 via-transparent to-white/5 rounded-xl"></div>
                      <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r from-blue-600 to-cyan-600"></div>
