...
const ConnectionStatus: React.FC<ConnectionStatusProps> = ({ status, error, onRetry }) => {
  if (status === 'connected') {
        ...
        <div className="flex-1">
          ...
          <div className="bg-red-100 rounded p-3 mb-4">
            ...
            <ol className="text-sm text-red-700 space-y-1 list-decimal list-inside">
              <li>Check your <code>.env</code> file exists in the project root</li>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <a
              ...
              className="inline-flex items-center px-3 py-2 bg-white text-red-600 text-sm border border-red-300 rounded-lg hover:bg-red-50 transition-colors"
            >
