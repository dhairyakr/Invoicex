...
import { X, Package, DollarSign, Tag, BarChart3, Save, AlertCircle, Sparkles, Shield, Zap } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4">
      ...
      <div className="relative w-full max-w-5xl max-h-[95vh] overflow-hidden">
        ...
        <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/30 overflow-hidden">
          ...
          {/* Form Content - Single Page Layout */}
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 text-lg font-medium"
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-green-500/20 focus:border-green-500 transition-all duration-300 text-lg font-semibold"
                            placeholder="0.00"
                            min="0"
                            step="0.01"
                            required
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-300"
                          placeholder="Enter stock quantity (optional)"
                          min="0"
                        />
                        <p className="text-xs text-gray-500 mt-1">Leave empty if you don't want to track inventory</p>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex flex-wrap gap-2">
                        {formData.tags.map((tag) => (
                          <span
                            key={tag}
                            className="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-gradient-to-r from-orange-500 to-yellow-500 text-white shadow-lg"
                          >
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          type="button"
                          onClick={addTag}
                          className="px-4 py-3 bg-gradient-to-r from-orange-500 to-yellow-500 text-white rounded-xl hover:from-orange-600 hover:to-yellow-600 transition-all duration-300 font-semibold shadow-lg"
                        >
                          Add
                        </button>
                      </div>
              ...
              <div className="flex justify-between items-center pt-6 border-t border-gray-200">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="relative group overflow-hidden px-8 py-3 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white rounded-xl font-semibold transition-all duration-300 hover:scale-105 transform shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
